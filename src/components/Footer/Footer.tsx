        ...
        <div className="footer__body">
          ...
          <div className="footer__column footer__column--catalog">
            ...
            <ul className="footer__list">
              <li className="footer__item">
                <a href="" className="footer__link">Фены Dyson Supersonic</a>
              </li>
              <li className="footer__item">
                <a href="" className="footer__link">Стайлеры Dyson Airwrap</a>
              </li>
              <li className="footer__item">
                <a href="" className="footer__link">Выпрямители Dyson Corrale</a>
              </li>
              <li className="footer__item">
                <a href="" className="footer__link">Пылесосы</a>
              </li>
              <li className="footer__item">
                <a href="" className="footer__link">Климатическая техника</a>
              </li>
              <li className="footer__item">
                <a href="" className="footer__link">Освещение</a>
              </li>
              <li className="footer__item">
          ...
          <div className="footer__column footer__column--info">
            ...
            <ul className="footer__list">
              ...
              <li className="footer__item">
                <a href="" className="footer__link">Гарантия</a>
              </li>
              <li className="footer__item">
                <a href="" className="footer__link">Оплата товара</a>
              </li>
              <li className="footer__item">
              ...
              <li className="footer__item">
                <a href="" className="footer__link">Договор оферты</a>
              </li>
            </ul>
          </div>
          ...
          <div className="footer__column footer__column--offers">
            ...
            <ul className="footer__list">
              <li className="footer__item">
                <a href="" className="footer__link">Подарочная коллекция</a>
              </li>
              <li className="footer__item">
                <a href="" className="footer__link">Эксклюзивные предложения</a>
              </li>
            </ul>
          </div>
